...
function showDeck() {
  ...
  //get api and create loop to iterate over to add image file
  $.ajax(deck).then(function (data) {
    ...
    //display the cards from the functions 
...
//functions to display meaning and image of first random card.
...
//functions to display meaning and image of second random card.
...
//functions to display meaning and image of third random card.
